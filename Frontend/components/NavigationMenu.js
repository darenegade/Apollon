    ...
    render(){
        ...
        return (
            <div className="list-group menu-list col-xs-12 col-md-6 col-md-offset-3 no-padding">
                ...
                <a className="list-group-item menu-list-item" onClick={this.handleClick} id="buy" style={ListElementStyle}>
                    <i className="fa fa-plus" aria-hidden="true" style={OrangeStyle}></i> Buy Music
                </a>
            </div>
        )
    }
